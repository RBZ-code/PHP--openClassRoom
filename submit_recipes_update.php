...
{
    $_SESSION['MESSAGE_ERROR'] = "Il manque des information pour permettre l'edition du formulaire";
...
if ($_SESSION['LOGGED_USER']['email'] !== $author) {
    die("Accès interdit : vous ne pouvez pas modifier cette recette.");
    header("Location: index.php");
}

if (!empty($errors)) {
    redirectToUrl("recipes_update.php?id=$id");
    exit();
}


$sqlQuery = "UPDATE recipes SET title = :title, recipe = :recipe, author = :author, is_enabled = :is_enabled WHERE recipe_id = :id";
...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="alert alert-success" role="alert">
        <p class="mb-0">Votre recette à était modifiée avec succes ! ✅</p>
    </div>
    <div class="container">
